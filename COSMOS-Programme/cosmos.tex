...
For reference, given $\sigma_t = 100\\mathrm{ns}$ and $\sigma_{B, \parallel} \approx 10\\mathrm{m}$, we obtain:
...
\begin{table}[h]
    ...
    \begin{tabular}{cccc}
        ...
        \hline
    \end{tabular}
    \caption{Angular uncertainty as a function of distance}
\end{table}


Note that $\sigma_\theta \sim \frac{1}{\mathbf{B}_\perp}$; as the baseline gets larger, the uncertainty decreases.
