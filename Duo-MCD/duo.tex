...
\title{Satellite Proposal: COSMOS-Duo}
...
\textit{\textcolor{blue}{Provide an overview of the steps planned or undertaken considering the regulative aspects of the mission and provide evidence of the activites. 
...
\textit{\textcolor{blue}{Provide the details of the supervisors of the project. A minimum of 2 supervisors shall cover the three functions. The key roles of team leader and system engineer must be untertaken by citizens of an eligible state.
}}
...
\begin{itemize}
    ...
    \item University/Tertiary Education Insitution
    \item Department
\end{itemize}
...
\begin{table}[h!]
    ...
    \begin{tabular}{|p{4cm}|p{4cm}|}
        ...
        (2) \textbf{Involveed} in the project \textbf{until} (MM YYYY) - expected date & (6) \textbf{Field of study} (e.g., aerospace engineering), \textbf{\& Specialisation} (e.g., Space Systems, Materials and Structure, etc.) \\
...
\textit{\textcolor{blue}{List al the technical requirements including:
\begin{itemize}
    \item \textbf{Requierement identification}: all requirements should be identified with a unique identifier.
